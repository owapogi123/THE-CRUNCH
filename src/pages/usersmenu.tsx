...
const normalizeName = (value: unknown) =>
  String(value ?? "")
    .trim()
    .toLowerCase();
const formatOrderItemCount = (quantity: number) =>
  `${quantity} item${quantity !== 1 ? "s" : ""}`;
const formatOrderPaymentLabel = (
  paymentMethod: string,
  paymentStatus: string | null,
  trackingStatus: string,
) => {
  ...
  const status = String(paymentStatus ?? trackingStatus ?? "").trim();
...
function mapInventoryRecipes(
  ...
  for (const row of inventoryRows ?? []) {
    if (
      String(row.item_type ?? "menu_item")
        .trim()
  ...
  return (
    <motion.button
      ...
      style={{
        padding: "6px 14px",
        borderRadius: 30,
        border: `1.5px solid ${active ? accent : "rgba(240,237,232,0.12)"}`,
        background: active ? `${accent}1a` : "rgba(240,237,232,0.04)",
        color: active ? accent : "rgba(240,237,232,0.55)",
        fontSize: 11.5,
        fontWeight: 600,
        cursor: "pointer",
        fontFamily: "inherit",
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          style={{ padding: isMobile ? "24px 20px 20px" : "32px 28px 28px" }}
        >
          <div
            style={{
              display: "flex",
              ...
              <AnimatePresence>
                {checked && (
                  <motion.span
                    ...
                    exit={{ scale: 0 }}
                    transition={SP}
                    style={{ color: "#f5c842", fontSize: 12, fontWeight: 800 }}
                  >
                    *
                  </motion.span>
                )}
        ...
        {methods.map((m) => {
          ...
          return (
            <motion.button
              ...
              transition={SP}
              style={{
                background: active ? `rgba(${m.rgb},0.1)` : "transparent",
                border: `1.5px solid ${active ? `rgba(${m.rgb},0.45)` : "transparent"}`,
                borderRadius: 11,
                padding: "12px 14px",
                cursor: "pointer",
                fontFamily: "inherit",
              ...
              {active && (
                <motion.div
                  ...
                  style={{
                    ...
                    height: 6,
                    borderRadius: "50%",
                    background: `rgb(${m.rgb})`,
                  }}
                />
              )}
              <span
                style={{
                  color: active ? `rgb(${m.rgb})` : "rgba(240,237,232,0.35)",
                  display: "flex",
                  alignItems: "center",
                }}
              >
        ...
        {selected === "cash" && (
          ...
          >
            ...
            >
              ...
              >
                You will pay at the store. Your order will only be prepared once
                full payment is received onsite.
              </p>
            </div>
          </motion.div>
        )}
              ...
              {[
                {
                  icon: bagD,
                  title: "Pick-up Order",
                  desc: "Order online and pick up your items at the store when it's ready.",
                  cta: "Browse the Menu",
                  action: onClose,
                  ctaStyle: { background: "#f5c842", color: "#111" },
                },
                {
                  icon: scooterD,
                  title: "Delivery Order",
                  desc: "Order for delivery through Foodpanda or Grab.",
                  cta: "Order via Delivery App",
                  action: () => setView("delivery"),
                  ctaStyle: {
                ...
                >
                  ...
                  {card.title === "Delivery Order" && (
                    <div
                      style={{ display: "flex", gap: 8, margin: "24px 0 28px" }}
                    >
                      {[
                        {
                          name: "FoodPanda",
                  ...
                  <div
                    style={{
                      marginTop: card.title === "Pick-up Order" ? 28 : 0,
                      padding: "12px 0",
                      borderRadius: 12,
                      textAlign: "center",
                      fontSize: 14,
            ...
            >
              ...
              >
                {[
                  {
                    label: "FoodPanda",
                    desc: "Order via the FoodPanda app",
...
function TrackingPanel({ orders }: { orders: CustomerOrder[] }) {
  ...
  return (
    <div style={{ marginBottom: 34, display: "grid", gap: 14 }}>
      ...
      >
        <h3
          style={{ fontSize: 20, fontWeight: 900, color: "#f0ede8", margin: 0 }}
        >
          Your order status
        </h3>
      ...
      {orders.map((order) => (
        <div
          ...
          style={{
            ...
            border: "1px solid rgba(240,237,232,0.08)",
            borderRadius: 22,
            padding: isNarrowPhone ? "18px 16px" : "22px 24px",
            display: "grid",
            gap: 14,
          }}
        >
          ...
          style={{
            ...
            padding: isPhone
              ...
              : isMobile
                ? "14px 18px 28px"
                : "16px 24px 32px",
            paddingBottom: isShortViewport ? 18 : undefined,
          }}
        >
          {orders.length === 0 ? (
            <div
            ...
            >
              <span style={{ color: "rgba(240,237,232,0.2)" }}>
                <Icon d={clipboardD} size={42} sw="1.2" />
              </span>
              <p
                style={{
              ...
              return (
                ...
                >
                  <motion.button
                    ...
                    whileHover={{ borderColor: "rgba(240,237,232,0.18)" }}
                    style={{
                      width: "100%",
                      background: isOpen
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          style={{
                            ...
                            color:
                              order.trackingStatus === "Cancelled"
                                ? "#f87171"
                                : "#4ade80",
                            border: `1px solid ${order.trackingStatus === "Cancelled" ? "rgba(239,68,68,0.22)" : "rgba(34,197,94,0.22)"}`,
                          }}
                        >
                          {order.trackingStatus}
                        </span>
                      ...
                      >
                        {order.items.slice(0, 6).map((item, ii) => (
                          <div
                            key={`${order.id}-thumb-${item.name}-${item.quantity}`}
                            title={item.name}
                            style={{
                              width: 22,
                              height: 22,
                    ...
                    >
                      ...
                      >
                        <Icon d={chevronD} size={13} sw="2.5" />
                      </motion.span>
                    </div>
                  </motion.button>
                      ...
                      >
                        <div style={{ padding: "6px 0" }}>
                          {order.items.map((item, ii) => (
                            <div
                              key={`${order.id}-line-${item.name}-${item.quantity}`}
                              style={{
                                display: "flex",
                                alignItems: "center",
                                gap: 12,
                            ...
                            >
                              ...
                              >
                                {formatOrderItemCount(item.quantity)}
                              </span>
                            </div>
                          ))}
                          <div
          ...
          return (
            <motion.button
              ...
              style={{
                padding: "6px 14px",
                borderRadius: 30,
                border: `1.5px solid ${active ? "#f5c842" : "rgba(240,237,232,0.12)"}`,
                background: active
  ...
  return (
    <div style={{ display: "flex", gap: 8, marginBottom: 18 }}>
      {(["original", "spicy"] as const).map((v) => (
        <Pill
          key={v}
          label={v === "spicy" ? "Spicy" : "Original"}
          active={selected === v}
          onClick={() => onChange(v)}
          accent={v === "spicy" ? "#f97316" : "#f5c842"}
        />
      ))}
    </div>
  );
          ...
          style={{
            ...
            padding: isPhone
              ...
              : isMobile
                ? "12px 18px"
                : "12px 28px",
            paddingBottom: isShortViewport ? 12 : undefined,
          }}
        >
          <AnimatePresence initial={false}>
            {cart.length === 0 ? (
                    ...
                    >
                      ...
                      >
                        <AnimatePresence mode="wait">
                          ...
                          >
                            {formatPHP(
                              Number(item.recipe.price * item.quantity),
                            )}
                          </motion.span>
                        </AnimatePresence>
                        <motion.button
            ...
            >
              ...
              >
                {[
                  ...
                  >
                    <span
                      style={{ fontSize: 13, color: "rgba(240,237,232,0.4)" }}
                    >
                      {label}
                    </span>
                    <span
                ...
                >
                  ...
                  <AnimatePresence mode="wait">
                    <motion.span
                      key={Math.round(billing.grandTotal * 100)}
                    ...
                    >
                      {formatPHP(Number(billing.grandTotal))}
                    </motion.span>
                  </AnimatePresence>
                </div>
              </div>
              <PaymentMethodSelector
                ...
                disabled={!isCash && !!paymentSession}
              />
              <div
                style={{
                  height: 1,
              ...
              <motion.button
                ...
                whileHover={{
                  scale: storeOpen && !isSubmitting ? 1.02 : 1,
                  backgroundColor:
                    storeOpen && !isSubmitting ? "#e6b800" : "#f5c842",
                }}
                whileTap={{ scale: storeOpen && !isSubmitting ? 0.97 : 1 }}
                transition={SP}
                style={{
                  width: "100%",
                  background: "#f5c842",
                  ...
                  cursor: isSubmitting
                    ...
                    : !storeOpen
                      ...
                      : "pointer",
                  fontFamily: "inherit",
                  opacity: isSubmitting || !storeOpen ? 0.55 : 1,
                }}
              >
      ...
      >
        ...
        >
          ...
          >
            {orderNumber && (
              <>
                <strong style={{ color: "#f5c842" }}>{orderNumber}</strong> is
                your pickup number.
                <br />
              </>
            )}
    ...
    >
      ...
      >
        <div
          style={{
            height: 3,
            background: "linear-gradient(90deg,#f5c842,rgba(245,200,66,0.25))",
          }}
        />
        <div style={{ padding: isMobile ? "24px 20px" : "28px 26px" }}>
          <div
            style={{
              display: "flex",
              justifyContent: "space-between",
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  ...
                  style={{
                    ...
                    height: 38,
                    borderRadius: 12,
                    border: `1px solid ${rating >= star ? "rgba(245,200,66,0.45)" : "rgba(240,237,232,0.1)"}`,
                    background:
                      rating >= star
                        ? "rgba(245,200,66,0.12)"
                        : "rgba(240,237,232,0.04)",
                    color:
                      rating >= star ? "#f5c842" : "rgba(240,237,232,0.28)",
                    cursor: "pointer",
                    fontSize: 18,
                    fontWeight: 800,
                  }}
          ...
          >
            ...
            <button
              ...
              onClick={onSubmit}
              disabled={
                isSubmitting || trimmedLength === 0 || feedbackText.length > 200
              }
              style={{
                flex: 2,
                borderRadius: 12,
                ...
                fontWeight: 800,
                cursor:
                  isSubmitting || trimmedLength === 0
                    ? "not-allowed"
                    : "pointer",
                opacity: isSubmitting || trimmedLength === 0 ? 0.55 : 1,
              }}
            >
    ...
    <motion.div
      ...
      style={{
        ...
        padding: isNarrowPhone
          ? "18px 16px"
          : "clamp(20px,4vw,32px) clamp(20px,4vw,36px)",
        border: "1px solid rgba(240,237,232,0.07)",
        display: "flex",
        flexWrap: "wrap",
        gap: isNarrowPhone ? 18 : "clamp(20px,4vw,40px)",
        alignItems: "flex-start",
        position: "relative",
        overflow: "hidden",
    ...
    >
      <div
        style={{
          ...
          background: isAvailable
            ...
            : "linear-gradient(90deg,transparent,rgba(240,237,232,0.06),transparent)",
        }}
      />
      ...
      <div style={{ flex: "1 1 260px" }}>
        ...
        >
          <h2
            style={{
              ...
              fontWeight: 800,
              color: isAvailable ? "#f0ede8" : "rgba(240,237,232,0.45)",
              margin: 0,
              lineHeight: 1.28,
              flex: 1,
            }}
        ...
        <div
          style={{
            display: "flex",
            gap: isNarrowPhone ? 12 : "clamp(14px,3vw,24px)",
            marginBottom: 20,
        ...
        >
          {[
            ...
            <div
              ...
              style={{
                textAlign: "center",
                minWidth: isNarrowPhone ? 58 : undefined,
              }}
            >
              <div
                style={{
                  ...
                  fontWeight: 800,
                  color: isAvailable ? "#f0ede8" : "rgba(240,237,232,0.3)",
                  lineHeight: 1,
                }}
              >
                {n.value}
        ...
        {isAvailable && recipe.variant !== undefined && (
          ...
          >
            <motion.button
              ...
              style={{
                ...
                cursor: "pointer",
                fontFamily: "inherit",
                flex: isNarrowPhone ? "1 1 100%" : "0 0 auto",
                justifyContent: "center",
              }}
            >
              {isFav ? "Saved" : "Save"}
            ...
            >
              <AnimatePresence mode="wait">
                <motion.span
                  key={
                    !isAvailable ? "unavailable" : justAdded ? "added" : "add"
                  }
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
          ...
          >
            ...
            <div
              style={{
                ...
                fontWeight: 900,
                color: isAvailable ? "#f5c842" : "rgba(240,237,232,0.3)",
                letterSpacing: "-0.04em",
              }}
            >
              {formatPHP(Number(recipe.price))}
            </div>
          </div>
        </div>
      </div>
      ...
      <motion.div
        ...
        style={{
          ...
          position: "relative",
          background: "#1a1208",
          margin: isNarrowPhone ? "0 auto" : undefined,
        }}
      >
        <img
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderRadius: 10,
        padding: isNarrowPhone ? "6px 10px 6px 8px" : "6px 12px 6px 8px",
        minWidth: 0,
      }}
    >
      <div
  ...
  return (
    ...
    >
      ...
      >
        ...
        <strong style={{ color: "#f0ede8" }}>{email}</strong>. Enter it below to
        unlock online ordering.
      </p>
      {error ? (
        <p style={{ margin: "14px 0 0", color: "#fca5a5", fontSize: 12 }}>
          {error}
        </p>
      ) : null}
      {success ? (
        <p style={{ margin: "14px 0 0", color: "#86efac", fontSize: 12 }}>
          {success}
        </p>
      ) : null}
      <div
...
export default function Delicacy() {
  ...
  const customerNeedsEmailVerification =
    String(user?.role || "")
      .trim()
      .toLowerCase() === "customer" && user?.email_verified !== true;
  ...
  useEffect(() => {
    const shouldLockScroll =
      orderTypeOpen || showCashTerms || showCheckout || feedbackRecipe !== null;
  ...
  }, [orderTypeOpen, showCashTerms, showCheckout, feedbackRecipe]);
  ...
  useEffect(() => {
    ...
    const loadMenuData = async () => {
      try {
        const inventoryRows = await api.get<InventoryMenuRow[]>(
        ...
        setActiveMeal(
          allMeals.includes("Lunch") ? "Lunch" : (allMeals[0] ?? "Lunch"),
        );
      } catch (err) {
  ...
  useEffect(() => {
    ...
    if (!raw) return;
    try {
      setPaymentSession(JSON.parse(raw));
    } catch {
  ...
  useEffect(() => {
    ...
    if (paymentState === "cancelled") {
      setDrawerOpen(true);
      setPaymentMessage(
        "GCash checkout was cancelled. You can try again when you're ready.",
      );
      clearParam();
      return;
    }
    ...
    setDrawerOpen(true);
    setPaymentMessage(
      "Payment return detected. Verifying your GCash payment...",
    );
    ...
    (async () => {
      try {
        const data = await api.get<{
          ...
          status: string;
          paymentReference: string | null;
        }>(`/paymongo/verify/${session!.checkoutSessionId}`);
        if (cancelled) return;
        setPaymentSession({ ...session!, ...data });
        setPaymentMessage(
          data.paid
            ? "Payment confirmed. You can now click Place Order."
            : "Payment still pending. Please check again.",
        );
      } catch {
        if (!cancelled)
          setPaymentMessage(
            "Could not verify payment automatically. Click Check Payment Status.",
          );
      } finally {
        clearParam();
      }
  ...
  const displayed = menuItems.filter(
    (r) =>
      ...
      return found
        ? prev.map((c) =>
            c.recipe.id === recipe.id
              ? { ...c, quantity: c.quantity + 1, flavors: recFlavors }
              : c,
          )
  ...
  const removeFromCart = (id: number) => {
    clearPayment();
    setCart((p) => p.filter((c) => c.recipe.id !== id));
  };
  ...
  const ensureCustomerCanPlaceOrder = () => {
    ...
    if (user.role && !isCustomerUser(user.role)) {
      setPaymentMessage(
        "Please log in using a customer account to place an order.",
      );
      return false;
    }
  ...
  const handlePlaceCashOrder = async () => {
    ...
    try {
      const res = await api.post<{ orderId: number; orderNumber: string }>(
        "/orders",
        {
          items: buildItems(),
      ...
      console.error(e);
      setPaymentMessage("Could not place your order. Please try again.");
    } finally {
  ...
  const handleSendPayment = async () => {
    ...
    try {
      ...
      setPaymentMessage(
        "Redirecting to GCash checkout. Complete payment there and you'll return here for verification.",
      );
  ...
  const handleVerifyPayment = async () => {
    ...
    try {
      const data = await api.get<{
        ...
        status: string;
        paymentReference: string | null;
      }>(`/paymongo/verify/${paymentSession.checkoutSessionId}`);
      setPaymentSession({ ...paymentSession, ...data });
      setPaymentMessage(
        data.paid
          ? "Payment confirmed. You can now click Place Order."
          : "Payment still pending. Finish GCash checkout, then check again.",
      );
    } catch {
      setPaymentMessage("Could not verify payment. Please try again.");
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  const handlePlaceOrder = async () => {
    if (!ensureCustomerCanPlaceOrder()) return;
    if (isSubmitting || !paymentSession?.paid) {
    ...
    try {
      ...
      setPaymentMessage(
        "Payment done, but could not place the order. Please try again.",
      );
    } finally {
      setIsSubmitting(false);
    }
  ...
  const handleVerifyEmail = async () => {
    ...
    try {
      ...
      setVerificationSuccess(
        "Email verified successfully. You can now place online orders.",
      );
      setVerificationCode("");
      setPaymentMessage(null);
    } catch (err: any) {
  ...
  const canSubmitFeedback = Boolean(user && isCustomerUser(user.role));
  ...
  const openFeedback = (recipe: Recipe) => {
    if (!user) {
      setPaymentMessage("Please log in to submit feedback.");
      return;
    }
    if (!isCustomerUser(user.role)) {
      setPaymentMessage("Only customer accounts can submit feedback.");
      return;
    }
  ...
  const submitFeedback = async () => {
    ...
    if (!isCustomerUser(user.role)) {
      setFeedbackMessage("Only customer accounts can submit feedback.");
      return;
    }
    ...
    if (cleanFeedback.length > 200) {
      setFeedbackMessage("Feedback must not exceed 200 characters.");
      return;
    }
    ...
    try {
      await api.post("/feedback", {
        product_id: feedbackRecipe.id,
        menu_item_id: feedbackRecipe.id,
        product_name: feedbackRecipe.name,
    ...
    >
      ...
      <motion.nav
        ...
        style={{
          ...
          borderBottom: "1px solid rgba(240,237,232,0.07)",
          padding: isNarrowPhone ? "10px 14px" : "0 clamp(16px,4vw,40px)",
          minHeight: 68,
          display: "flex",
          justifyContent: "space-between",
          alignItems: "center",
          gap: isNarrowPhone ? 10 : 12,
          flexWrap: isNarrow ? "wrap" : "nowrap",
          paddingTop: isNarrow && !isNarrowPhone ? 12 : undefined,
      ...
      >
        ...
        >
          ...
          />
          {!isNarrowPhone && (
            <span style={{ fontSize: 20, fontWeight: 900, color: "#f0ede8" }}>
        ...
        >
          {NAV_LINKS.map((item) => (
            <motion.button
              ...
              style={{
                ...
                cursor: "pointer",
                fontFamily: "inherit",
                fontSize: isNarrowPhone ? 12.5 : 13.5,
                fontWeight: 500,
                color: "rgba(240,237,232,0.45)",
                padding: isNarrowPhone ? "7px 10px" : "7px 14px",
                borderRadius: 8,
              }}
              onMouseEnter={(e) => {
          ...
          <motion.button
            ...
            style={{
              ...
              border: "none",
              borderRadius: 10,
              padding: isNarrowPhone ? "9px 14px" : "9px 20px",
              cursor: "pointer",
              fontFamily: "inherit",
              fontSize: 13,
              fontWeight: 700,
              ...
              >
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(240,237,232,0.12)",
                    borderRadius: 10,
                    padding: isNarrowPhone ? "9px 12px" : "9px 18px",
                    cursor: "pointer",
                    fontFamily: "inherit",
                    fontSize: 13,
                    fontWeight: 600,
      ...
      <div
        style={{
          maxWidth: 1200,
          margin: "0 auto",
          padding: "clamp(24px,5vw,52px) clamp(16px,4vw,40px) 0",
          position: "relative",
          zIndex: 1,
        }}
      >
        ...
        >
              ...
              {user && (
                <motion.div
                  ...
                  style={{
                    ...
                    borderRadius: 14,
                    padding: isNarrowPhone ? "10px 12px" : "10px 16px",
                    maxWidth: "100%",
                  }}
                >
                  <div style={{ color: "#f5c842", display: "flex" }}>
                    <Icon d={userD} size={15} />
                  </div>
          ...
          >
            ...
            {restaurantSettings.tagline ? (
              <span style={{ fontSize: 13, color: "rgba(240,237,232,0.68)" }}>
                {restaurantSettings.tagline}
              </span>
            ) : null}
        ...
        >
          {(loading ? ["All", "Chicken", "Sides", "Drinks"] : categories).map(
            (cat) => (
              <motion.button
                key={cat}
                ...
                style={{
                  ...
                  cursor: "pointer",
                  fontFamily: "inherit",
                  fontSize: isNarrowPhone ? 13 : 14,
                  fontWeight: activeCategory === cat ? 700 : 400,
                  color:
                    activeCategory === cat
                      ? "#f5c842"
                      : "rgba(240,237,232,0.3)",
                  padding: isNarrowPhone ? "12px 16px" : "13px 22px",
                  position: "relative",
                  whiteSpace: "nowrap",
                }}
              >
                  ...
                  return (
                    ...
                    >
                      ...
                      <RecipeCard
                        ...
                        flavorSel={
                          flavorSels[recipe.id] ? flavorSels[recipe.id] : []
                        }
                        variantSel={
                          variantSels[recipe.id]
                            ? variantSels[recipe.id]
                            : "original"
                        }
                        onToggleFav={() =>
                          setFavorites((p) =>
                            p.includes(recipe.id)
                              ? p.filter((f) => f !== recipe.id)
                              : [...p, recipe.id],
                          )
                        }
                        onAddToCart={() => addToCart(recipe)}
                        onFlavorChange={(f) =>
                          setFlavorSels((p) => ({ ...p, [recipe.id]: f }))
                        }
                        onVariantChange={(v) =>
                          setVariantSels((p) => ({ ...p, [recipe.id]: v }))
                        }
                        onOpenFeedback={() => openFeedback(recipe)}
      ...
      <AnimatePresence>
        {showCashTerms && (
          <CashTermsModal
            ...
            onDecline={() => setShowCashTerms(false)}
          />
        )}
      </AnimatePresence>
      <AnimatePresence>
      ...
      <AnimatePresence>
        {feedbackRecipe && (
          <FeedbackModal
            ...
            onTextChange={(value) => {
              setFeedbackText(value.slice(0, 200));
              setFeedbackMessage(null);
            }}
