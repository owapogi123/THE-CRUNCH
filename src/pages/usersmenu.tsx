  ...
  Sides: [
    {
      id: 50,
      name: "Kimchi",
      description: "Traditional fermented kimchi. Perfect add-on to any meal.",
    ...
    },
    {
      id: 51,
      name: "Fishcake",
      description: "Savory fishcake slices. Perfect add-on to any meal.",
    ...
    },
    {
      ...
      description: "Bucket of crispy flavored chicken skin. Choice of flavor.",
      image: "https://bit.ly/3P6DcAK",
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(245,200,66,0.05) 0%,transparent 65%)",
          }}
        />
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(245,200,66,0.03) 0%,transparent 65%)",
          }}
        />
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(245,200,66,0.04) 0%,transparent 65%)",
          }}
        />
      </div>
