                      ...
                      <div style={{ padding: "6px 0" }}>
                        {order.items.map((item, ii) => (
                          <div key={`${order.id}-line-${item.name}-${item.quantity}`} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 16px", borderBottom: ii < order.items.length - 1 ? "1px solid rgba(240,237,232,0.05)" : "none" }}>
                            ...
                            <span style={{ fontSize: 10.5, fontWeight: 700, padding: "3px 9px", borderRadius: 20, background: "rgba(240,237,232,0.06)", color: "rgba(240,237,232,0.4)", border: "1px solid rgba(240,237,232,0.09)" }}>{formatOrderItemCount(item.quantity)}</span>
                          </div>
                        ))}
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 16px 6px", borderTop: "1px solid rgba(240,237,232,0.07)" }}>
                          ...
                          <span style={{ fontSize: 10.5, color: "rgba(240,237,232,0.28)" }}>{formatOrderPaymentLabel(order.paymentMethod, order.paymentStatus, order.trackingStatus)}</span>
