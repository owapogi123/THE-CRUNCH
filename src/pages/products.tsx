...
const STATIC_PRODUCTS: Product[] = [
  ...
  { id: 6,  name: '3 pcs. Chicken w/ Rice',      menuName: '3 pcs. Chicken With Rice and Drink',  category: 'Chicken', rating: 4.8, badge: 'Bestseller', description: '3 pieces of crispy fried chicken with steamed rice.',        price: 188, spicy: false, img: 'https://bit.ly/4r1CAtC' },
  { id: 10, name: 'Chicken Skin Bucket',         menuName: 'Classic Chicken Skin Bucket',         category: 'Sides',   rating: 4.7, badge: 'Must Try',   description: 'BBQ, Sour Cream, or Cheese — choose your favorite.',        price: 158, spicy: false, img: 'https://bit.ly/3P6DcAK' },
  { id: 11, name: 'Chicken Shots Bucket',        menuName: 'Chicken Shots Bucket',                category: 'Sides',   rating: 4.6, badge: '',           description: 'A full bucket of our bite-sized crispy chicken shots.',      price: 178, spicy: false, img: 'https://bit.ly/40Z9n7T' },
  { id: 12, name: 'Twister Fries',               menuName: 'Twister Fries',                       category: 'Sides',   rating: 4.8, badge: 'Must Try',   description: 'Seasoned spiral-cut fries — crispy, seasoned, and addictive.', price: 145, spicy: false, img: 'https://i.pinimg.com/736x/e1/fe/5d/e1fe5d75042f22074b9ec16f1db491f4.jpg' },
  { id: 13, name: 'Regular Fries',               menuName: 'Twister Fries',                       category: 'Sides',   rating: 4.4, badge: '',           description: 'Classic golden fries, perfectly salted and crispy.',         price: 69,  spicy: false, img: 'https://i.pinimg.com/1200x/95/02/12/9502126d74d78185aca0697e53c91197.jpg' },
  { id: 14, name: 'Tteokbokki',                  menuName: 'Tteokbokki',                          category: 'Sides',   rating: 4.5, badge: '',           description: 'Chewy Korean rice cakes in a spicy-sweet sauce.',            price: 95,  spicy: true,  img: 'https://bit.ly/3MMEeRT' },
  { id: 15, name: 'Fishcake',                    menuName: 'Fishcake',                            category: 'Sides',   rating: 4.6, badge: 'Bestseller', description: 'Savory fishcake slices — the perfect crowd-pleasing add-on.', price: 95,  spicy: false, img: 'https://bit.ly/4s9ZvUC' },
  { id: 16, name: 'Kimchi',                      menuName: 'Kimchi',                              category: 'Sides',   rating: 4.3, badge: '',           description: 'Traditional fermented kimchi. Tangy, spicy, and punchy.',    price: 55,  spicy: true,  img: 'https://bit.ly/47bPoX5' },
  { id: 17, name: 'The Crunch Burger w/ Cheese', menuName: 'The Crunch Burger with Cheese',       category: 'Sides',   rating: 4.7, badge: 'Must Try',   description: 'Crispy chicken on a toasted bun, topped with melted cheese.', price: 104, spicy: false, img: 'https://i.pinimg.com/736x/d4/38/09/d4380931a50783483fc53d55209245e1.jpg' },
  { id: 20, name: 'Kiwi Fruit Soda',             menuName: 'Kiwi Fruit Soda',                     category: 'Drinks',  rating: 4.8, badge: 'Bestseller', description: 'Bright, citrusy kiwi soda. Bestselling flavor.',             price: 50,  spicy: false, img: 'https://shorturl.at/sBHbi',       isDrink: true },
  { id: 21, name: 'Lychee Fruit Soda',           menuName: 'Lychee Fruit Soda',                   category: 'Drinks',  rating: 4.6, badge: '',           description: 'Floral, delicate lychee — light and perfectly sweet.',       price: 50,  spicy: false, img: 'https://shorturl.at/RuKTf',       isDrink: true },
  ...
  { id: 25, name: 'Mango Fruit Soda',            menuName: 'Mango Fruit Soda',                    category: 'Drinks',  rating: 4.7, badge: '',           description: 'Tropical mango fizz — juicy, golden, and summer-ready.',     price: 50,  spicy: false, img: 'https://shorturl.at/MvNpm',       isDrink: true },
  ...
  { id: 31, name: '3 pcs. Chicken w/ Rice & Drink', menuName: '3 pcs. Chicken With Rice and Drink', category: 'Combos', rating: 4.9, badge: 'Best Value', description: '3 pcs. crispy chicken + steamed rice + fruit soda.',         price: 228, spicy: false, img: 'https://bit.ly/4r1CAtC' },
        ...
        <>
          ...
          >
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(245,200,66,0.1)', border: '1px solid rgba(245,200,66,0.3)', borderRadius: 40, padding: '8px 20px' }}>
              ...
              />
              <span style={{ fontSize: 11, fontWeight: 700, color: '#f5c842', letterSpacing: '0.18em', textTransform: 'uppercase', fontFamily: "'Poppins', sans-serif" }}>
                Taking you there
              </span>
            </div>
...
function MenuRow({ item, index }: { item: MenuItem; index: number }) {
  return (
    <motion.div
      ...
      style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '11px 0', borderBottom: '1px solid rgba(255,255,255,0.06)' }}
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
        <span style={{ fontSize: 13.5, color: 'rgba(240,237,232,0.72)', fontWeight: 400 }}>{item.name}</span>
        {item.tag && (
          <span style={{ fontSize: 9, fontWeight: 700, padding: '3px 10px', borderRadius: 999, background: 'rgba(245,200,66,0.15)', color: '#f5c842', letterSpacing: '0.08em', textTransform: 'uppercase', border: '1px solid rgba(245,200,66,0.25)' }}>
            {item.tag}
          </span>
        )}
        {item.note && (
          <span style={{ fontSize: 10, color: 'rgba(240,237,232,0.28)', fontStyle: 'italic' }}>{item.note}</span>
        )}
      </div>
        ...
        <motion.div style={{ maxWidth: 1280, margin: '0 auto', y: heroY, opacity: heroOpacity }}>
          <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.6 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.25em', textTransform: 'uppercase', color: '#f5c842', fontFamily: "'Poppins', sans-serif" }}>
                The Crunch Fairview
              </span>
            </div>
          </motion.div>
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    borderRadius: 28,
                    overflow: 'hidden',
                    border: `1px solid ${isHov ? (isDrink ? 'rgba(147,210,255,0.35)' : 'rgba(245,200,66,0.32)') : 'rgba(255,255,255,0.08)'}`,
                    boxShadow: isHov
                      ? `0 32px 72px rgba(0,0,0,0.6), 0 0 0 1px ${isDrink ? 'rgba(147,210,255,0.08)' : 'rgba(245,200,66,0.08)'}, inset 0 1px 0 rgba(255,255,255,0.07)`
                ...
                >
                  ...
                  <div style={{ position: 'relative', height: 220, overflow: 'hidden', background: '#1a1208' }}>
                    ...
                    {isHov && (
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        style={{ position: 'absolute', inset: 0, background: isDrink ? 'linear-gradient(135deg,rgba(99,179,237,0.07),transparent)' : 'linear-gradient(135deg,rgba(245,200,66,0.08),transparent)' }}
                      />
                    )}
                    {badge && (
                      <span style={{ position: 'absolute', top: 14, left: 14, background: badge.bg, color: badge.textDark ? '#111' : '#fff', fontSize: 10, fontWeight: 700, padding: '4px 12px', borderRadius: 999, letterSpacing: '0.05em', textTransform: 'uppercase', boxShadow: `0 4px 16px ${badge.bg}55` }}>
                        {badge.label}
                      </span>
                    )}
                    {p.spicy && (
                      <motion.div
                        animate={{ rotate: isHov ? [0, -12, 12, 0] : 0 }}
                  ...
                  <div style={{ padding: '18px 22px 22px' }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 10, marginBottom: 6 }}>
                      ...
                      <span style={{ flexShrink: 0, fontSize: 10, fontWeight: 500, padding: '3px 10px', borderRadius: 999, background: 'rgba(255,255,255,0.05)', color: 'rgba(240,237,232,0.28)', border: '1px solid rgba(255,255,255,0.07)', marginTop: 2 }}>
                        {p.category}
                      </span>
                    </div>
        ...
        <Reveal style={{ marginTop: 104 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 20, alignItems: 'start' }}>
            ...
            <motion.div
              ...
              style={{ background: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(28px)', WebkitBackdropFilter: 'blur(28px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 28, padding: '32px 28px', position: 'relative', overflow: 'hidden', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.06), 0 8px 40px rgba(0,0,0,0.4)' }}
            >
            ...
            >
              ...
              <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at top left, rgba(245,200,66,0.04) 0%, transparent 60%)', pointerEvents: 'none' }} />
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 6 }}>
                <h3 style={{ margin: 0, fontFamily: "'Poppins', sans-serif", fontSize: 18, fontWeight: 700, color: '#f0ede8', letterSpacing: '-0.01em' }}>Sides</h3>
                <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.06)' }} />
              </div>
